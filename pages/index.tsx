...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 dark xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between sm:bg-red-400 md:bg-teal-400 lg:bg-indigo-400 xl:bg-yellow-400 2xl:bg-pink-500 p-6 rounded-3xl shadow-xl">
        ...
        <button
          className="mt-5 dark:bg-black dark:border-white dark:border bg-blue-500 text-white p-3
        text-center rounded-xl w-3/4 block mx-auto 
        hover:bg-teal-500  dark:hover:bg-black dark:hover:text-white hover:text-black
      ...
      <div className="bg-white overflow-hidden rounded-3xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-zinc-400 rounded-full group-hover:bg-red-300 transition-color" />
